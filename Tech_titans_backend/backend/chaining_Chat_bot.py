...
def chat_function(user_input: str, client: openai.ChatCompletion):
    ...
    You are an election manifesto extractor. Based on the input, extract the candidate names mentioned, They are just the names of the people in the user prompt(Sajith Premadasa, Anura Kumara Dissanayake, Ranil Wickremesinghe). Return them as a comma-separated list.
    """
    ...
    def generate_questions(client: openai.ChatCompletion, conversation_context: str):
        ...
        You are a question generator. Based on the conversation context provided, generate a list of potential follow-up questions for the user to choose from.
